...
const HeroCardSection = () => {
  ...
  return (
    <div className="w-screen h-fit overflow-hidden min-w-screen max-w-screen flex justify-center items-center">
      <div
        ref={containerRef}
        className="w-[1000px] hero-animation relative flex items-center justify-between pt-10 md:pt-16 h-fit"
      >
        ...
        <div className="w-1/2 h-full flex items-center justify-start flex-col gap-4 pl-6 pr-8 py-6 min-w-[450px]">
          {cards.left.map((p, index) => (
            <motion.div
              ...
              className={`w-full h-24 rounded-2xl border flex items-center gap-4 flex-row-reverse px-4 ${
            ...
            >
              ...
              <div className="flex-1 flex flex-col gap-2 ">
                <div
                  className={`${hindMadurai.className} pl-2 text-lg flex justify-between items-center flex-row-reverse`}
                >
                  <div>{p.name}</div>
                  <div
        ...
        <div className="w-[5px] bg-zinc-200 py-6 self-stretch">
        ...
        <div className="w-1/2 h-full flex items-center justify-start flex-col gap-4 pr-6 pl-8 py-6 min-w-[450px]">
